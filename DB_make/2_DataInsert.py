...
if (True):
# try:
  values = [('ad 1', 'admin', 'admin', 'admin', 'M', '서울특별시', '1997.06.30', '01012341234'),
            ('su 2', 'ljh0001', 'ljh0001', '이재훈', 'M', '경상남도', '1998.01.27', '01012341234'),
            ('su 3', 'jmj0002', 'jmj0002', '조민주', 'F', '경상북도', '2000.01.01', '01012341234'),
            ('su 4', 'psj0003', 'psj0003', '박선종', 'M', '충청북도', '1988.05.07', '01012341234'),
            ('as 5', 'lsh0004', 'lsh0004', '이수현', 'F', '강원도', '2001.07.03', '01012341234'),
            ('as 6', 'sec0005', 'sec0005', '성은채', 'F', '전라남도', '1998.09.03', '01012341234'),
  ...
  values = [('1', 'su 2', 'as 5', '1', '2020,11.01', '2020,11.01', '2020,12.01', '서식.csv', '2', '8.9', '8', 'P'),
            ...
            ('2', 'su 3', 'as 7', '1', '2020,11.30', '2020,11.06', '2020,12.06', '경식2.csv', '2', '1.2', '', 'W')]
